...
internal class AttachSessionResponseHandler : IResponseHandler
{
    public AttachSessionResponseHandler(SessionContainer sessionRef)
    {
    }

    public void OnSuccess(IDictionary<string, object> metadata)
    {
        Console.WriteLine("Successfully attached to session");
    }
